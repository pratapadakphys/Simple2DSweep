...
<Library LVVersion="25008000">
	...
	<Item Name="Cryo Magnet (SubVI).vi" Type="VI" URL="../Cryo Magnet (SubVI).vi"/>
	<Item Name="Modify Target with timeout (SubVI).vi" Type="VI" URL="../Modify Target with timeout (SubVI).vi"/>
	<Item Name="my_GPIB_comm_IPS.vi" Type="VI" URL="../my_GPIB_comm_IPS.vi"/>
	<Item Name="text adding (Biswajit).vi" Type="VI" URL="../text adding (Biswajit).vi"/>
</Library>
